...
def test_create_and_add_cards(setup_database):
    ...
    # Unused card objects
    crd = Card(amount=200, code="1".rjust(6, "0"))
    crd1 = Card()
    ...
    # Used card objects
    crd = UsedCard(amount=200, code="1".rjust(6, "0"), balance_after_use=200, user_id=1)
    crd1 = UsedCard()
...
def test_methods(setup_database):
    ...
    crd = Card(amount=200, code="1".rjust(6, "0"))
    used_crd = UsedCard(amount=200, code="2".rjust(6, "0"), balance_after_use=200, user_id=1)
